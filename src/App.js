...
function App(){
    ...
    const getShortUrlFromServer = (data) =>{
        ...
        axios.post("http://localhost:8080/",data.originalurl, {
            headers: {
      ...
      <div className="App">
        ...
        <div className="container">
                <div className="header">
                    <h1 className="fs-2"><u>URL shortening Application</u></h1>
                </div>
                ...
                <div className="container overflow-auto div1 rounded w-75 mt-3">
